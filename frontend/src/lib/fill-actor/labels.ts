...
export const MOVE_ERROR_LABELS: Record<string, string> = {
  ...
  cloud_move_permission_denied: 'CloudDrive 账号缺少移动权限',
  cloud_move_unauthenticated: 'CloudDrive 认证失败，请检查 API 令牌',
  cloud_move_invalid_request: 'CloudDrive 拒绝了移动参数',
  cloud_move_unsupported: 'CloudDrive 不支持该移动操作',
